...
function Theme() {
  ...
  return (
    ...
    >
      <span
        className={`absolute top-0.5 left-0.5 w-5.5 h-5.5 rounded-full transition-all duration-300 flex items-center justify-center ${
      ...
      >
        {isDark ? (
          // Lune blanche/jaune claire pour le mode sombre
          <svg
